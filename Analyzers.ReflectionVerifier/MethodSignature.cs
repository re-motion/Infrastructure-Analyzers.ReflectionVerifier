...
public readonly struct MethodSignature (string nameInclusiveClass, ITypeSymbol?[] parameters)
{
  ...
  {
    return NameInclusiveClass == other.NameInclusiveClass && Parameters.SequenceEqual(other.Parameters);
  }

  public override int GetHashCode ()
  {
    return NameInclusiveClass.GetHashCode() ^ Parameters.GetHashCode();
  }
